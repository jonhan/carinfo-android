...
data class CarAttributes(val regno: String
  ...
  companion object {
    @JvmField
    val CREATOR = PaperParcelCarAttributes.CREATOR
  }
}
...
data class Emission(val gasoline: FuelEmission?
  ...
  companion object {
    @JvmField
    val CREATOR = PaperParcelEmission.CREATOR
  }
  ...
  data class FuelEmission(val co2: DrivingValues) : PaperParcelable {
    companion object {
      @JvmField
      val CREATOR = PaperParcelEmission_FuelEmission.CREATOR
    }
  }
}
...
data class Fuel(val gasoline: FuelType?
  ...
  companion object {
    @JvmField
    val CREATOR = PaperParcelFuel.CREATOR
  }
  ...
  data class FuelType(@SerializedName("average_consumption") val averageConsumption: DrivingValues) : PaperParcelable {
    companion object {
      @JvmField
      val CREATOR = PaperParcelFuel_FuelType.CREATOR
    }
  }
}
...
data class DrivingValues(val urban: Double?
  ...
  companion object {
    @JvmField
    val CREATOR = PaperParcelDrivingValues.CREATOR
  }
}
